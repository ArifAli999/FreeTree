...
>(({ className, children, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-20 bg-black/80  transition-all duration-100 data-[state=closed]:animate-out data-[state=open]:fade-in data-[state=closed]:fade-out",
      className
    )}
    {...props}
    ref={ref}
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex  sm:flex-row justify-between  sm:space-x-2",
      className
    )}
    {...props}
  />
